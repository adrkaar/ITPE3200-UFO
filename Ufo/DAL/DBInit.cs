        ...
        public static void Initialize(IApplicationBuilder app)
        {
            ...
            //{
                ...
                */
                ...
                var observasjon1 = new Observasjon { Dato = "22.22.01", Navn="er", Tid = "22.22", Beskrivelse = "Jeg gikk ut pub og så en stor egg i skyen.", Lokasjon = "Her" };
                var observasjon2 = new Observasjon { Dato = "30.01.01", Navn = "er", Tid = "00.09", Beskrivelse = "Bla-bla-bla.", Lokasjon = "Der" };
