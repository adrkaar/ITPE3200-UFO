    ...
    public class DBInit
    {
        public static void Initialize(IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                /* Observations */
                var observation1 = new Observations { Date = "2022-09-21", Time = "22:22", Latitude = "56.66015", Longitude = "14.077921", UfoTypes = type1, Description = "I went outside and saw a big egg in the sky" };
                var observation2 = new Observations { Date = "2022-10-01", Time = "00:09", Latitude = "48.6479", Longitude = "9.8650", UfoTypes = type3, Description = "I saw an UFO!!" };
                ...
                var observation12 = new Observations { Date = "2022-09-04", Time = "03:00", Latitude = "32.169414", Longitude = "-95.730057", UfoTypes = type1, Description = "I saw one in the woods one night, looks like a blue ball of energy far away, poofing in and out of air like it has camo or something" };
