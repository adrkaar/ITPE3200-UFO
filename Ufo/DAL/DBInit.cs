    ...
    public class DBInit
    {
        public static void Initialize(IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                /* Observations */
                var observation1 = new Observations { Date = "2022-09-21", Time = "22:22", Latitude = "56.66015", Longitude = "14.0779", UfoTypes = type1, Description = "I went outside and saw a big egg in the sky", Users = user1 };
                var observation2 = new Observations { Date = "2022-10-01", Time = "00:09", Latitude = "48.647983", Longitude = "9.865054", UfoTypes = type3, Description = "I saw an UFO!!", Users = user1 };
