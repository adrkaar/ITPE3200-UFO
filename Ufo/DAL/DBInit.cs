    ...
    public class DBInit
    {
        public static void Initialize(IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                /* Observations */
                var observation1 = new Observations { Date = "2022-09-21", Time = "22:22", Latitude = "56.660151627670686", Longitude = "14.07792153985528", UfoTypes = type1, Description = "I went outside and saw a big egg in the sky" };
                var observation2 = new Observations { Date = "2022-10-01", Time = "00:09", Latitude = "48.647983479154824", Longitude = "9.865054057063944", UfoTypes = type3, Description = "I saw an UFO!!" };
